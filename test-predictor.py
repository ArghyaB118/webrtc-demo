...
# load data
data = read_csv('Results/test1.csv', header=0, index_col=0)
data = data.iloc[25:]
data.drop(['Stream ID','RTP SN'], inplace=True, axis=1)
...
# load dataset
#dataset = read_csv('data-processed.csv', header=0, index_col=0)
